...
import com.tcl.collect.LongSparseLongArray;
...
//    }
    ...
    private static boolean isActiveAndVisible(DownloadInfo download) {
        return download.mStatus == Downloads.Impl.STATUS_RUNNING &&
                (download.mVisibility == DownloadManager.Request.VISIBILITY_VISIBLE
                || download.mVisibility == DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
    }
    ...
    private static boolean isCompleteAndVisible(DownloadInfo download) {
        return Downloads.Impl.isStatusCompleted(download.mStatus) &&
                (download.mVisibility == DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED
                || download.mVisibility == DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_ONLY_COMPLETION);
    }
}
