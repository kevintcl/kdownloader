...
import com.tcl.download.utils.ArrayUtils;
...
class RealSystemFacade implements SystemFacade {
    ...
    public NetworkInfo getActiveNetworkInfo(int uid) {
        ...
        final NetworkInfo activeInfo =  connectivity.getActiveNetworkInfo();// connectivity.getActiveNetworkInfoForUid(uid);
    ...
    public boolean isActiveNetworkMetered() {
        final ConnectivityManager conn = (ConnectivityManager) mContext.getSystemService(Context.CONNECTIVITY_SERVICE);//ConnectivityManager.from(mContext);
        return conn == null ? false : conn.isActiveNetworkMetered();
    }
    ...
    public boolean isNetworkRoaming() {
        ...
        boolean isRoaming = isMobile && (telephonyManager == null? false : telephonyManager.isNetworkRoaming());////TelephonyManager.getDefault().isNetworkRoaming();
    ...
    private boolean isCleartextTrafficPermitted(String packageName) {
        ...
        return (applicationInfo.flags & (1<<27)) != 0;//ApplicationInfo.FLAG_USES_CLEARTEXT_TRAFFIC) != 0;// public static final int FLAG_USES_CLEARTEXT_TRAFFIC = 1<<27
    }
}
