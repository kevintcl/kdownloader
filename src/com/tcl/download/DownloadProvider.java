...
import com.tcl.collect.Maps;
import com.tcl.download.DownloadManager.Request;
import com.tcl.download.utils.IndentingPrintWriter;
...
public final class DownloadProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "kdownloads";
    /** Database filename */
    private static final String DB_NAME = "downloads.db";
    /** Current database version */
    private static final int DB_VERSION = 1;//109;
...
//            }
        ...
        private void  addDownloadsTableColumns(SQLiteDatabase db) {
           addColumn(db, DB_TABLE, Downloads.Impl.COLUMN_ALLOW_ROAMING,
                     "INTEGER NOT NULL DEFAULT 0");
           addColumn(db, DB_TABLE, Downloads.Impl.COLUMN_ALLOWED_NETWORK_TYPES,
                     "INTEGER NOT NULL DEFAULT 0");
...
//            final AppOpsManager appOps = getContext().getSystemService(AppOpsManager.class); //kevint
//            if (appOps.noteProxyOp(/*AppOpsManager.OP_WRITE_EXTERNAL_STORAGE*/60, //kevint
...
//                        DownloadStorageProvider.onDownloadProviderDelete(getContext(), id);
    ...
    //dumpsys activity provider com.tcl.download.DownloadProvider
//    @Override kevint
