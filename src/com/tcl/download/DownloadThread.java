...
import static com.tcl.download.Constants.TAG;
import static com.tcl.download.Downloads.Impl.STATUS_BAD_REQUEST;
import static com.tcl.download.Downloads.Impl.STATUS_CANCELED;
import static com.tcl.download.Downloads.Impl.STATUS_CANNOT_RESUME;
import static com.tcl.download.Downloads.Impl.STATUS_FILE_ERROR;
import static com.tcl.download.Downloads.Impl.STATUS_HTTP_DATA_ERROR;
import static com.tcl.download.Downloads.Impl.STATUS_SUCCESS;
import static com.tcl.download.Downloads.Impl.STATUS_TOO_MANY_REDIRECTS;
import static com.tcl.download.Downloads.Impl.STATUS_UNHANDLED_HTTP_CODE;
import static com.tcl.download.Downloads.Impl.STATUS_UNKNOWN_ERROR;
import static com.tcl.download.Downloads.Impl.STATUS_WAITING_FOR_NETWORK;
import static com.tcl.download.Downloads.Impl.STATUS_WAITING_TO_RETRY;
...
import com.tcl.download.utils.IoUtils;
import com.tcl.download.DownloadInfo.NetworkState;
...
//            wakeLock.setWorkSource(new WorkSource(mInfo.mUid)); kevint
            wakeLock.acquire();

            // while performing download, register for rules updates
//            netPolicy.registerListener(mPolicyListener); kevint
...
//            netPolicy.unregisterListener(mPolicyListener);
     ...
     * {@link com.tcl.download.Downloads.Impl#STATUS_WAITING_TO_RETRY}.
     */
