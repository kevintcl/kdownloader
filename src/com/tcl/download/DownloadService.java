...
public class DownloadService extends Service {
    ...
    private static ExecutorService buildDownloadExecutor() {
        final int maxConcurrent = 4;//Resources.getSystem().getInteger(
//                com.android.internal.R.integer.config_MaxConcurrentDownloadsAllowed);
    ...
    public void onCreate() {
        ...
        JobScheduler js = (JobScheduler) getSystemService(Context.JOB_SCHEDULER_SERVICE);//TODO kevint after 5.0
    ...
    private boolean updateLocked() {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                staleIds.remove(id);
                Log.i("kevint", "DownloadService===========updateLocked===id=="+id+",mDownloads.size="+mDownloads.size());
                DownloadInfo info = mDownloads.get(id);
                Log.d("kevint", "DownloadService===========updateLocked===id=="+id+",info==null?="+(info==null));
                if (info != null) {
