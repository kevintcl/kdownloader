...
import com.tcl.download.Downloads.Impl;
import com.tcl.download.utils.IndentingPrintWriter;
import com.tcl.download.utils.ReflectUtil;
...
public class DownloadInfo {
    ...
    private NetworkState checkSizeAllowedForNetwork(int networkType, long totalBytes) {
        ...
        boolean isNetworkTypeMobile = false;
        
        try {
        	isNetworkTypeMobile = (Boolean) ReflectUtil.invoke(ConnectivityManager.class, "isNetworkTypeMobile", networkType);
        ...
        if (/*ConnectivityManager.isNetworkTypeMobile(networkType)*/isNetworkTypeMobile) {
    ...
    public boolean isOnCache() {
        return mDestination == Downloads.Impl.DESTINATION_CACHE_PARTITION_PURGEABLE;
    }
