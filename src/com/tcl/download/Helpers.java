...
import com.tcl.download.utils.FileUtils;
...
public class Helpers {
    ...
    static boolean isFilenameValid(Context context, File file, boolean allowInternal) {
        try {
            ...
            final StorageVolume[] volumes = StorageManager.getVolumeList(UserHandle.myUserId(),0);// StorageManager.getVolumeList(UserHandle.myUserId(),StorageManager.FLAG_FOR_WRITE);
